...
out_folder <- paste0(processeddata_folder, "larix_decidua_extraction/1000pres_1000abs/subset_2/")
...
load("D:/species/processed/larix_decidua/1000pres_1000abs/occurrence_subset_2.Rdata")
...
phenofit_extract_climate(1969, "Larix decidua", species_occurrence, processeddata_folder, out_folder, "PenmanMonteith")
for( yr in 1970:2000){
  print(yr)
  phenofit_extract_climate(yr, "Larix decidua", species_occurrence, processeddata_folder, out_folder, "PenmanMonteith")
}
...
phenofit_extract_all_climate(1950:2020, processeddata_folder, out_folder, "PenmanMonteith", filter = filter_df)
