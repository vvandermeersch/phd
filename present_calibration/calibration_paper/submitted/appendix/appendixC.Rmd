...
fagus_map <- ggplot() + 
  ...
  geom_tile(data = fsyl_presabs[fsyl_presabs$pres==1,], aes(x = lon, y = lat), fill = "#0C8346", alpha=0.5) +
  geom_tile(data = fsyl_presabs[fsyl_presabs$pres==0,], aes(x = lon, y = lat), fill = "#D57A66", alpha=0.4) +
  theme_void() +
  ylab("") +
  xlab("") +
...
quercus_map <- ggplot() + 
  geom_sf(data = eu_map_cropped, fill = 'grey', alpha=0.1, color='grey', size = 0.1) +
  geom_tile(data = qile_presabs[qile_presabs$pres==1,], aes(x = lon, y = lat), fill = "#0C8346", alpha=0.5) +
  geom_tile(data = qile_presabs[qile_presabs$pres==0,], aes(x = lon, y = lat), fill = "#D57A66", alpha=0.4) +
  theme_void() +
  ylab("") +
  xlab("") +
  theme(legend.title.align = 0.5, legend.position = "bottom", 
...
abies_map <- ggplot() + 
  geom_sf(data = eu_map_cropped, fill = 'grey', alpha=0.1, color='grey', size = 0.1) +
  geom_tile(data = aalb_presabs[aalb_presabs$pres==1,], aes(x = lon, y = lat), fill = "#0C8346", alpha=0.5) +
  geom_tile(data = aalb_presabs[aalb_presabs$pres==0,], aes(x = lon, y = lat), fill = "#D57A66", alpha=0.4) +
  theme_void() +
  ylab("") +
  xlab("") +
  theme(legend.title.align = 0.5, legend.position = "bottom", 
