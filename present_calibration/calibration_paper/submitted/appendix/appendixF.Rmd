...
```{r phenofit_output_maps, include=TRUE, fig.height = 7, fig.width = 4.5, fig.align = "center", fig.cap = "Fitness index predicted by PHENOFIT with the forward and the backward calibrations.", fig.pos="H", fig.showtext=TRUE, eval = T}
...
ggdraw(p) +
  draw_label("Forward calibration", color = "#495057", size = 10, angle = 0, y = 0.92, x = 0.29,
             fontfamily = "Linux Libertine G", fontface = "italic") +
  draw_label("Backward calibration", color = "#495057", size = 10, angle = 0, y = 0.92, x = 0.75,
             fontfamily = "Linux Libertine G", fontface = "italic") +
...
```{r best_forward_maps, include=TRUE, fig.height = 8, fig.width = 4.5, fig.align = "center", fig.cap = "Carbon reserves predicted by CASTANEA with the forward and the backward calibrations.", fig.pos="H", fig.showtext=TRUE, eval = T}
...
ggdraw(p) +
  draw_label("Forward calibration", color = "#495057", size = 10, angle = 0, y = 0.92, x = 0.28,
             fontfamily = "Linux Libertine G", fontface = "italic") +
  draw_label("Backward calibration", color = "#495057", size = 10, angle = 0, y = 0.92, x = 0.75,
             fontfamily = "Linux Libertine G", fontface = "italic") +
  draw_label("Fagus sylvatica", color = "#495057", size = 10, angle = 90, y = 0.75, x = 0.04,
