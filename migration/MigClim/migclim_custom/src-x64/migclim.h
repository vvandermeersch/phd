...
extern int     nrRows, nrCols, envChgSteps, dispSteps, dispDist, dispDist_LDD, iniMatAge,
               fullMatAge, rcThreshold, barrierType,
               noData, replicateNb;
extern double *dispKernel, *dispKernel_LDD, *propaguleProd, lddFreq, xllCorner, yllCorner, // dispkernel_LDD add by VV
               cellSize;
...
bool mcSrcCell_LDD           (int i, int j, int **curState, int **pxlAge,
			  int loopID, int habSuit, int **barriers);
