...
combine_models <- FALSE
pollen_folder <- "D:/species/pollen/processed/abies_alba/025deg/002adp_thr"
models <- data.frame(name = c("PHENOFIT",
                               "PHENOFIT (fitted)",
                               "Random Forest",
                               "Lasso GLM",
...
pollen_folder <- "D:/species/pollen/processed/quercus_deciduoustype/025deg/002adp_thr"
models <- data.frame(name = c("PHENOFIT",
                               "PHENOFIT (fitted)",
                               "Random Forest",
                               "Lasso GLM",
...
pollen_folder <- "D:/species/pollen/processed/betula_pendula/025deg/002adp_thr"
models <- data.frame(name = c("PHENOFIT",
                               "PHENOFIT (fitted)",
                               "Random Forest",
                               "Lasso GLM",
...
pollen_folder <- "D:/species/pollen/processed/larix_decidua/025deg/002adp_thr"
models <- data.frame(name = c("PHENOFIT",
                              "PHENOFIT (fitted)",
                              "Random Forest",
                              "Lasso GLM",
