...
write_dscl_gwgen_csv <- function(years, extent, source_dir, output_dir, 
                                 WHC_present, debug_wet = F, debug_wndcld = F, debug_years = F){
  ...
  r_tmin <- rast(file.path(source_dir, "tempmin_av_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_24000_0kyr", 
                           paste0("tempmin_av_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_", filename, ".nc")),
                 subds = "tempmin_av", opts="HONOUR_VALID_RANGE=NO")
  r_tmax <- rast(file.path(source_dir, "tempmax_av_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_24000_0kyr", 
                           paste0("tempmax_av_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_", filename, ".nc")),
                 subds = "tempmax_av", opts="HONOUR_VALID_RANGE=NO")
  r_pre <- rast(file.path(source_dir, "precip_mm_srf_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_24000_0kyr", 
                          paste0("precip_mm_srf_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_", filename, ".nc")),
                subds = "precip_mm_srf", opts="HONOUR_VALID_RANGE=NO")
  r_wet <- rast(file.path(source_dir, "rd3_mm_srf_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_24000_0kyr", 
                          paste0("rd3_mm_srf_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_", filename, ".nc")),
                subds = "rd3_mm_srf", opts="HONOUR_VALID_RANGE=NO")
  r_cloud <- rast(file.path(source_dir, "totCloud_mm_ua_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_24000_0kyr", 
                            paste0("totCloud_mm_ua_old_sims_1yrAvg_monthly_10minRes_CRU_Europe_", filename, ".nc")),
                  subds = "totCloud_mm_ua", opts="HONOUR_VALID_RANGE=NO")
  r_uwind <- rast(file.path(source_dir, "u_mm_10m_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_24000_0kyr", 
                            paste0("u_mm_10m_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_", filename, ".nc")),
                  subds = "u_mm_10m", opts="HONOUR_VALID_RANGE=NO")
  r_vwind <- rast(file.path(source_dir, "v_mm_10m_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_24000_0kyr", 
                            paste0("v_mm_10m_old_sims_1yrAvg_monthly_10minRes_noBias_Europe_", filename, ".nc")),
