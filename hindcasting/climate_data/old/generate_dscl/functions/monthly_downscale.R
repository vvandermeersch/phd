...
monthly_downscale <- function(yr_interval, years_list = NULL,
  ...
  for(l in years_list){
    ...
    pre_LR_HR <- mask(resample(pre_LR, alt_HR), alt_HR)
    ...
    alt_HR <- mask(alt_HR, subset(pre_LR_HR,1))
    ...
    writeCDF(pre_LR_HR, file.path(out_folder, "precip_mm_srf_old_sims_1yrAvg_monthly_15minRes_CRU_Europe_24000_0kyr",
