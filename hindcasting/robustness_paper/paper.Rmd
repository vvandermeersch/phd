...
```{r figure_climate_overview, fig.height = 105, fig.width = 180, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Climate overview"}
...
# source(file.path(wd, "scripts", "data_processing", "model_outputs.R"))
source(file.path(wd, "scripts", "data_processing", "model_outputs_withmig.R"))
