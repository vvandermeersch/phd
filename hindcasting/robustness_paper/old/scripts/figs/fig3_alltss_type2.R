...
model_performance_median <- model_performance_withmig %>%
  group_by(type2, median = round(median,2)) %>%
...
conoverTest_out <- conover.test::conover.test(x=model_performance_withmig[model_performance_withmig$crit == TRUE,]$mig_tss, 
...
conoverTest_out <- conover.test::conover.test(x=model_performance_withmig[model_performance_withmig$crit == FALSE,]$mig_tss, 
