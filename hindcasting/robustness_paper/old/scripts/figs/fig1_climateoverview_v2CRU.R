...
main_plot <- ggplot() +
  ...
  labs(y = "ANNUAL MEAN TEMPERATURE  (°C)", x = "YEARS (BP)", fill = "CLIMATE NOVELTY") +
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(),
        ...
        legend.text = element_text(colour = "black", family= "Helvetica Narrow", size = 7, margin = margin(t = -3)),
  ...
  annotate("text", x = 14800, y = 12.8, label = "LATE PLEISTOCENE", color = "black", family= "Helvetica Narrow", size = 3) +
  annotate("text", x = 6000, y = 12.8, label = "HOLOCENE", color = "black", family= "Helvetica Narrow", size = 3) +
  
  annotate("text", x = 12300, y = -1, label = "Younger\nDryas", color = "white", angle = 90,
           family= "Helvetica Narrow", size = 3.4) +
  annotate("text", x = 13750, y = -1, label = "Bølling-\nAllerød", color = "white", angle = 90,
           family= "Helvetica Narrow", size = 3.4) +
...
d18O_plot <- ggplot() +
  ...
  theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(),
        ...
        axis.title.y.right = element_text(colour = "black", family= "Helvetica Narrow", size = 8,
                                          margin = margin(l = 5)))
