...
conf_intervals <- rbind(
  ...
  data.frame(newdata,mig_tss=predict(p_exppb,newdata),
  ...
  data.frame(newdata,mig_tss=predict(p_fitpb,newdata),
  ...
  data.frame(newdata,mig_tss=predict(p_csdm,newdata),
