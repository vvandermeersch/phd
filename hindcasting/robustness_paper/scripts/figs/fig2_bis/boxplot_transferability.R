...
#-------------------------------------------#
# Fig.2-c: Boxplot of model transferability #
#-------------------------------------------#
...
data_letters_late[data_letters_late$test == "2Crossvalidationreference", "sign_position"] <- -22
...
boxplot_transferability <- ggplot(model_performance_relchg) +
  ...
  scale_color_manual(breaks= c("1Correlative", "3Fittedprocessbased", "4Expertprocessbased"),
                     values= c( "#457b9d", "#995D81", "#e86117"),
                     labels = c("Correlative", "Fitted process-based", "Expert process-based")) +
  scale_fill_manual(breaks= c("1Correlative", "3Fittedprocessbased", "4Expertprocessbased"),
                    values= c( "#457b9d", "#995D81", "#e86117"),
                    labels = c("Correlative", "Fitted process-based", "Expert process-based")) +
  theme_bw() + 
