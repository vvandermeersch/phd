...
data_letters_late[data_letters_late$test == "2Crossvalidationreference", "sign_position"] <- -4
...
data_letters_early[data_letters_early$test == "2Crossvalidationreference", "sign_position"] <- -42
