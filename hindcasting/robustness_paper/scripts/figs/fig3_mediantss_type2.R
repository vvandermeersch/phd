...
tss_performance <- ggplot(model_performance_lp, aes(x = median, y = median_var, color = type2, fill = type2)) +
  ...
  scale_color_manual(breaks= c("Treebased", "Regressionbased", 'Expertprocessbased', "Fittedprocessbased"),
                     values= c( "#457b9d", "#82BCC4", "#e86117","#995D81"),
                     labels = c("Tree-based", "Regression-based", 'Expert calibration', "Inverse calibration")) +
  scale_fill_manual(breaks= c("Treebased", "Regressionbased", 'Expertprocessbased',  "Fittedprocessbased"),
                    values= c( "#457b9d", "#82BCC4", "#e86117", "#995D81"),
                    labels = c("Tree-based", "Regression-based", 'Expert calibration', "Inverse calibration")) +
  theme_bw() + 
