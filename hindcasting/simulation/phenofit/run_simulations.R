...
output_folder <- "D:/simulations/phenofit/paleo/05deg_wocor"
climate_folder <- "D:/climate/HadCM3B_60Kyr_Climate/2023_dataset/phenofit_format/05deg_wocor"
...
for(year in c(5000)){
  ...
  system.time(shell(run, intern=FALSE))
